...
class AppColors {
  ...
  static const Color green6 = Color(0xFFF0FDF4); // ×8
  ...
  static const Color green31 = Color(0xFFE8F5EE); // ×1

  // teal
  static const Color teal = Color(0xFF163B45); // ×1

  // blue
  static const Color blue = Color(0xFF6558FF); // ×39
  static const Color blue2 = Color(0xFF374151); // ×10
  static const Color blue3 = Color(0xFF3B82F6); // ×9
  static const Color blue4 = Color(0xFF394452); // ×4
  static const Color blue5 = Color(0xFF635BFF); // ×3
  ...
  static const Color blue13 = Color(0xFFD0D5DD); // ×1
  ...
  static const Color red8 = Color(0xFFFFE3E6); // ×5
  ...
  static const Color red20 = Color(0xFFFFE6E6); // ×1
  static const Color red21 = Color(0xFFFFF1F1); // ×1
  ...
  // orange
  static const Color orange = Color(0xFFE8E1D7); // ×8
  ...
  // grey
  static const Color grey = Color(0xFF667085); // ×93
  ...
  static const Color grey6 = Color(0xFF687184); // ×20
  ...
  static const Color grey12 = Color(0xFFE8EDEA); // ×4
  static const Color grey13 = Color(0xFF2D2D2D); // ×3
  static const Color grey14 = Color(0xFFDDD8D1); // ×3
  static const Color grey15 = Color(0xFFE4EDE8); // ×3
  static const Color grey16 = Color(0xFF424242); // ×2
  ...
  static const Color grey20 = Color(0xFF303030); // ×1
  static const Color grey21 = Color(0xFF3B3B3B); // ×1
  static const Color grey22 = Color(0xFF3F3F3F); // ×1
  ...
  static const Color grey29 = Color(0xFFD1D5DB); // ×1
  static const Color grey30 = Color(0xFFD9D9D9); // ×1
  static const Color grey31 = Color(0xFFDCE1E7); // ×1
  static const Color grey32 = Color(0xFFDFDDD8); // ×1
  static const Color grey33 = Color(0xFFE1DDD6); // ×1
  static const Color grey34 = Color(0xFFE5E5E5); // ×1
  static const Color grey35 = Color(0xFFE5EBE7); // ×1
  static const Color grey36 = Color(0xFFE6E2DA); // ×1
  ...
  // white
  static const Color white = Color(0xFFF8FAF9); // ×18
  static const Color white2 = Color(0xFFF5F6FA); // ×14
  static const Color white3 = Color(0xFFF2F4F7); // ×13
  static const Color white4 = Color(0xFFF0F2F5); // ×10
  static const Color white5 = Color(0xFFF9FAFB); // ×8
  static const Color white6 = Color(0xFFF0FAF5); // ×6
  static const Color white7 = Color(0xFFF4F6F9); // ×6
  static const Color white8 = Color(0xFFF3F4F6); // ×4
  static const Color white9 = Color(0xFFE9EDF1); // ×3
  static const Color white10 = Color(0xFFFEF2F2); // ×3
  static const Color white11 = Color(0xFFE7EBEF); // ×2
  static const Color white12 = Color(0xFFEAEFEC); // ×2
  static const Color white13 = Color(0xFFF4F6F8); // ×2
  static const Color white14 = Color(0xFFF6F8FA); // ×2
  static const Color white15 = Color(0xFFF7F5F2); // ×2
  static const Color white16 = Color(0xFFFFFFFF); // ×2
  static const Color white17 = Color(0x80FFFFFF); // ×1
  static const Color white18 = Color(0xFFEAF4EF); // ×1
  static const Color white19 = Color(0xFFEDF0F2); // ×1
  static const Color white20 = Color(0xFFEDF0F3); // ×1
  static const Color white21 = Color(0xFFEEF0F4); // ×1
  static const Color white22 = Color(0xFFF0ECE6); // ×1
  static const Color white23 = Color(0xFFF1F1F1); // ×1
  static const Color white24 = Color(0xFFF3F3EF); // ×1
  static const Color white25 = Color(0xFFF5F4F0); // ×1
  static const Color white26 = Color(0xFFF6F4EF); // ×1
  static const Color white27 = Color(0xFFF7FAF8); // ×1
