...
final goRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) {
      final isAuthenticated = loginState.user != null;
      final isOnAuthRoute = state.matchedLocation == AppRoutes.login ||
          state.matchedLocation == AppRoutes.signup;

      // If authenticated and trying to visit an auth screen, go to home.
      // TODO: replace AppRoutes.login with your home route once it exists.
