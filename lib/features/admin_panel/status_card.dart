...
class StatusCard extends StatelessWidget {
  ...
  const StatusCard({super.key, required this.width, required this.height});
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const Divider(),
                const StatusRow(title: 'Total Shops', value: '186 registered'),
                const Divider(),
                const StatusRow(
                  title: 'NFC Tags',
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: const Color(0xffCBE8D1)),
                  ),
                  child: Row(
                    children: [
                      Icon(
