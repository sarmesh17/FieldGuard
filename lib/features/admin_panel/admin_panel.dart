import 'package:fieldguard/features/admin_panel/admin_section.dart';
import 'package:fieldguard/features/admin_panel/status_card.dart';
                ...
                children: [
                  ...
                  AdminSection(
                    ...
                    items: [
                      ...
                      MenuItemData(title: 'Manage Reps', badge: '24 reps'),
                      MenuItemData(title: 'Register New Manager'),
                      MenuItemData(title: 'View All Users'),
                    ],
                  ),
                  SizedBox(height: hp(.025)),
                  AdminSection(
                    ...
                    items: [
                      ...
                      MenuItemData(title: 'View All Shops', badge: '186 shops'),
                    ],
                  ),
                  SizedBox(height: hp(.025)),
                  AdminSection(
                    ...
                    items: [
                      ...
                      MenuItemData(title: 'Geofence Radius', badge: '75m'),
                  ...
                  AdminSection(
                    ...
                    title: 'Reports & Audit',
                    items: [
                      MenuItemData(title: 'Full System Audit Log'),
                      MenuItemData(title: 'Export All Data'),
                      MenuItemData(title: 'Fraud History Report'),
                    ],
                  ),
                  SizedBox(height: hp(.03)),
                  DangerZone(width: w),
...
class StatusRow extends StatelessWidget {
  ...
  const StatusRow({super.key, required this.title, required this.value});
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Expanded(
          child: Text(title, style: const TextStyle(color: Color(0xff757575))),
        ),
...
class DangerZone extends StatelessWidget {
  ...
  const DangerZone({super.key, required this.width});

  @override
  Widget build(BuildContext context) {
    final items = ['Deactivate a Rep', 'Reset Shop NFC Tag', 'Wipe Daily Data'];
        ...
        children: [
          ...
          ...List.generate(
            ...
            (index) => Column(
              children: [
                if (index != 0)
                  Divider(height: 0, color: Colors.red.withOpacity(.12)),
                Padding(
                  padding: EdgeInsets.symmetric(
                    horizontal: width * .05,
                    vertical: width * .05,
...
class MenuItemData {
  ...
  MenuItemData({required this.title, this.badge, this.icon, this.iconColor});
}
